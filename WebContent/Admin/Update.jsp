...
<%
	...
	if (result) {
		candidateDTO.setDivision(
				request.getParameter("division") == null ? null : request.getParameter("division"));
		candidateDTO.setNumber(
				Integer.valueOf(request.getParameter("number") == null ? "0" : request.getParameter("number")));
%>
<!DOCTYPE html>
<html>
	...
	<div id="wrapper">
		...
		<div id="content" class="shadow-box">
			<form action="../UpdateAction" method="post"
				...
				%>
				<div id="header">후보자 수정</div>
				<div id="content-detail">
					<div id="apply-explain">
						<div id="apply-alert">※실제 사용자에게 보여지는 페이지 모습입니다.</div>
						<div id="apply-choice">
							<input name="division" type="radio" id="student" checked
								value="<%=candidateDTO.getDivision()%>"> <label
								for="student"><%=candidateDTO.getDivision()%></label> <input
								name="number" type="number"
								value="<%=candidateDTO.getNumber()%>" style="display: none;">
						</div>
					</div>
					<%
						if (candidateDTO.getDivision().equals("학생회")) {
					%>
					<div id="super-title"><%="기호 " + candidateDTO.getNumber() + "번"%></div>
					<div id="member">
						<div class="title">
						...
						<div class="member-cover" id="student-member-cover">
							<div class="member">
								...
								? "../Upload/Picture/" + candidateDTO.getDivision() + "/" + candidateDTO.getNumber()
										+ "/masterGovernmentPicture.png?"
								: "../img/noPhoto.png"%>">
									<div class="photo-ico">
								...
								<div class="member-detail">
									...
									<div class="member-name candidate-input">
										<input type="text" value="<%=candidateDTO.getMaster()%>"
											name="masterGovernment">
									</div>
								</div>
							</div>
							<div class="member">
								...
								? "../Upload/Picture/" + candidateDTO.getDivision() + "/" + candidateDTO.getNumber()
										+ "/slave1GovernmentPicture.png?"
								: "../img/noPhoto.png"%>">
									<div class="photo-ico">
										<label for="s-file2"></label> <input type="file" id="s-file2"
											class="photo" name="slave1GovernmentPicture">
									</div>
								</div>
								<div class="member-detail">
									<div class="member-position">학생회 부회장 후보</div>
									<div class="member-name candidate-input">
										<input type="text" value="<%=candidateDTO.getSlave1()%>"
											name="slave1Government">
									</div>
								</div>
							</div>
							<div class="member">
								...
								? "../Upload/Picture/" + candidateDTO.getDivision() + "/" + candidateDTO.getNumber()
										+ "/slave2GovernmentPicture.png?"
								: "../img/noPhoto.png"%>">
									<div class="photo-ico">
										<label for="s-file3"></label> <input type="file" id="s-file3"
											class="photo" name="slave2GovernmentPicture">
									</div>
								</div>
								<div class="member-detail">
									<div class="member-position">학생회 부회장 후보</div>
									<div class="member-name candidate-input">
										<input type="text" value="<%=candidateDTO.getSlave2()%>"
											name="slave2Government">
									</div>
								</div>
							</div>
							<div class="member">
								...
								? "../Upload/Picture/" + candidateDTO.getDivision() + "/" + candidateDTO.getNumber()
										+ "/slave3GovernmentPicture.png?"
								: "../img/noPhoto.png"%>">
									<div class="photo-ico">
										<label for="s-file4"></label> <input type="file" id="s-file4"
											class="photo" name="slave3GovernmentPicture">
									</div>
								</div>
								<div class="member-detail">
									<div class="member-position">학생회 부회장 후보</div>
									<div class="member-name candidate-input">
										<input type="text" value="<%=candidateDTO.getSlave3()%>"
											name="slave3Government">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="member-cover" id="autonomy-member-cover">
							<div class="member">
								...
								? "../Upload/Picture/" + candidateDTO.getDivision() + "/" + candidateDTO.getNumber()
										+ "/masterMinistryPicture.png?"
								: "../img/noPhoto.png"%>">
									<div class="photo-ico">
										<label for="a-file1"></label> <input type="file" id="a-file1"
											class="photo" name="masterMinistryPicture">
									</div>
								</div>
								<div class="member-detail">
							...
							<div class="member">
								...
								? "../Upload/Picture/" + candidateDTO.getDivision() + "/" + candidateDTO.getNumber()
										+ "/slaveMinistryPicture.png?"
								: "../img/noPhoto.png"%>">
									<div class="photo-ico">
										<label for="a-file2"></label> <input type="file" id="a-file2"
											class="photo" name="slaveMinistryPicture">
									</div>
								</div>
								<div class="member-detail">
					...
					<div id="promise">
						...
						<div class="hr"></div>
						<textarea rows="15" id="promise-cover" name="commitment"><%=candidateDTO.getCommitment()%></textarea>
					</div>
					<div id="poster">
						<div class="title">
							...
							: "../img/noPhoto.png"%>">
								<div class="photo-ico">
									<label for="poster-file-1"></label> <input type="file"
										id="poster-file-1" class="photo" name="poster1Poster">
								</div>
							</div>
							<div class="poster file-upload">
								<img id="poster2"
							...
							: "../img/noPhoto.png"%>">
								<div class="photo-ico">
									<label for="poster-file-2"></label> <input type="file"
										id="poster-file-2" class="photo" name="poster2Poster">
								</div>
							</div>
						</div>
					</div>
				...
				<div id="candidate-btn-cover">
					<input type="button" value="취소" class="candidate-btn"
						id="candidate-cancel"> <input type="submit" value="후보자 수정"
						class="candidate-btn" id="candidate-edit">
				</div>
			</form>
		</div>
		<%
